...
def main():
	...
	while workers <= thread_counter:
		while u <= 5:
			...
			print("**********************************************************************************************")
			if sql_version == "mssql":
				args = "python3 database_loader.py {} {} {} {} {} {} {} {} {} {}".format(users,user_number,rows_per_user,sql_version,database_name,host,username,password,sql_version_number, sql_port)
			else:
				args = "python3 database_loader.py {} {} {} {} {} {} {} {} {}".format(users,user_number,rows_per_user,sql_version,database_name,host,username,password,temp_path)
